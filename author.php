		...
		<div class="container">
			<div class="row">
				...
				<div class="user-profile-icons text-center">
					...
					<?php if ('' != $user_contactemail = get_user_meta($user_info->ID, 'ipin_user_contactemail', true) && $user_ID != $user_info->ID) { //edited: send message ?>
					<a class="post-email<?php if (current_user_can('subscriber')) echo ' hidden'; ?>" href=""><?php _e('Send Message', 'ipin'); ?></a>
					<?php } ?>
					
					<?php if ($user_info->ipin_user_contactnumber || $user_info->ipin_user_contactskype) { ?>
						<br />
						<?php if ($user_info->ipin_user_contactnumber) { ?>
							<?php echo esc_attr($user_info->ipin_user_contactnumber); ?> &nbsp;
						<?php } ?>
					...
					<?php if ($user_info->ipin_user_location) { ?>
						<br />
						<a href="http://maps.google.com/?q=<?php echo rawurlencode($user_info->ipin_user_location); ?>" target="_blank"><?php echo esc_attr($user_info->ipin_user_location); ?></a> 
					<?php } ?>
					<!-- Legal -->
					<?php if ($user_info->ipin_user_legaltype == 'legal' && $user_info->ipin_user_legalid != '' && $user_info->ipin_user_legaladdress != '') { ?>
						<br />
						<?php echo esc_attr($user_info->ipin_user_legalid); ?>;
						<?php echo esc_attr($user_info->ipin_user_legaladdress); ?>
					<?php } ?>
				</div>
				<!-- end legal -->
				<?php //edited: send message ?>
				<div id="post-report-box"></div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								$user_contactemail = $user_info->ipin_user_contactemail;
								?>
								...
								<p></p>
								<input type="hidden" id="email-post-id" value="<?php echo $user_info->user_email; ?>" />
								<p></p>
